...
class DaoExercice
{
    ...
    function MdlE_getAll(): string
    {
        ...
        $requette = "SELECT exercice.ide, exercice.idc, exercice.nom, exercice.photo, exercice.description, categorie.groupe
        FROM Exercice
    ...
    function MdlE_getUnExercice($ide): string
    {
        global $reponse;
        $connexion = DBConnexion::getDBConnexion();
        $requette = "SELECT exercice.ide, exercice.nom, exercice.photo, exercice.description, categorie.groupe, exercice.idc
        FROM Exercice
        INNER JOIN categorie ON exercice.idc=categorie.idc
    ...
    function MdlE_getParRecherche($recherche): string
    {
        global $reponse;
        $connexion = DBConnexion::getDBConnexion();
        $requette = "SELECT exercice.ide, exercice.nom, exercice.photo, exercice.description, categorie.groupe
        FROM Exercice
        INNER JOIN categorie ON exercice.idc=categorie.idc
